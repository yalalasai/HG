...
(function () {
    ...
    angular
        ...
        .controller('MendixTeamServerWidgetDetailController', MendixTeamServerWidgetDetailController);

        MendixTeamServerWidgetDetailController.$inject = ['$scope', '$uibModalInstance', 'collectorName', 'collectorNiceName'];
    function MendixTeamServerWidgetDetailController($scope, $uibModalInstance,  collectorName, collectorNiceName) {
        var ctrl = this;
