...
(function () {
    ...
    angular
        ...
        .controller('MendixDeployWidgetDetailController', MendixDeployWidgetDetailController);

        MendixDeployWidgetDetailController.$inject = ['$scope', '$uibModalInstance', 'collectorName', 'collectorNiceName'];
    function MendixDeployWidgetDetailController($scope, $uibModalInstance,  collectorName, collectorNiceName) {
        var ctrl = this;
