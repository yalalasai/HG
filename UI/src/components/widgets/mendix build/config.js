...
(function () {
    ...
    angular
        ...
        .controller('MendixBuildWidgetConfigController', MendixBuildWidgetConfigController);
        MendixBuildWidgetConfigController.$inject = ['modalData', '$scope', 'collectorData', '$uibModalInstance'];
    function MendixBuildWidgetConfigController(modalData, $scope, collectorData, $uibModalInstance) {
        var ctrl = this,
        ...
        $scope.getJobs = function (filter) {
        	return collectorData.itemsByType('mendixbuild', {"search": filter, "size": 20}).then(function (response){
        		return response;
        	});
        }
