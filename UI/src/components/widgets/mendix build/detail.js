...
(function () {
    ...
    angular
        ...
        .controller('MendixBuildWidgetDetailController', MendixBuildWidgetDetailController);

        MendixBuildWidgetDetailController.$inject = ['$scope', '$uibModalInstance', 'collectorName', 'collectorNiceName'];
    function MendixBuildWidgetDetailController($scope, $uibModalInstance,  collectorName, collectorNiceName) {
        var ctrl = this;
